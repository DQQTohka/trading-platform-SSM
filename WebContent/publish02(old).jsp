...
<div id="cover" style="min-height: 639px;">
    <div id="user_area">   
        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="published" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="changeinfo" id="dir">
                        ...
                        <div class="sha">
                            <div class="publ">
                                <div class="pub_con">
                                    <div class="text_pu">
                                        <input type="text" name="remark" class="emoji-wysiwyg-editor"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="changeinfo">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-1">
                                    <div class="form-group">
                                        <div class="col-sm-10">
                                            <input type="file" name="file" data-ref="imgUrl" class="col-sm-10 myfile" value=""/>
                    	...
                    	<input type="submit" class="setting-save" value="发布物品" style="margin-top: 20px;background-color: orange;"/>
                </form:form>
            </div>
