...
<script type="text/javascript"> 
   ...
   function f(){
	 ...
	 document.getElementById('price').value = str.replace(reg, "");
   }
...
<div class="pay">
	...
	<div class="tr_recharge">
		<div class="tr_rechtext">
			...
			<p>1.你可以选择支付宝或者是微信的付款方式来进行充值，每次10元起充。</p>
		</div>
		<form action="recharge" class="am-form" id="doc-vld-msg" onsubmit="return f()">
			...
			<div class="tr_rechbox">
				<div class="tr_rechhead">
					...
					<div class="tr_rechheadcion">
						...
						<span>当前余额：<span>${user.balance}</span></span>
					</div>
				</div>
				...
				<div class="tr_rechcho am-form-group">
					...
					<label class="am-radio">
							<input type="radio" name="radio1" value="" ><img src="images/wechatpay.png">
						</label>
					<label class="am-radio" style="margin-right:30px;">
							<input type="radio" name="radio1" value="" ><img src="images/zfbpay.png">
						</label>
				</div>
				<div class="tr_rechnum">
					<span>应付金额：</span>
					<p class="rechnum" id="test">0.00元</p>
				</div>
			</div>
			<div class="tr_paybox">
				<input type="submit" value="确认支付" class="tr_pay am-btn" />
				<span>温馨提示：遇到问题请拨打联系电话12345。</span>
			</div>
		</form>
	</div>
</div>
